...
```{r}
t.test(df_democracies$`Freedom of discussion for men`, 
       df_democracies$`Freedom of discussion for women`)
...
```{r}
t.test(df_autocracies$v2smgovshutcap, df_autocracies$v2smgovshut)
